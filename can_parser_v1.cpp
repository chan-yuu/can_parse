 ...
 * @Date: 2025-06-16 13:01:57
 * @LastEditors: CYUN && cyun@tju.enu.cn
 * @LastEditTime: 2025-06-21 16:41:43
 * @FilePath: /cyun/Project/galactic_framework/ch_sen/chassis/chassis/app/can_parse/can_parser_v1.cpp
 * @Description: 自适应处理不同结构的dbc文件,只需要把输出的结构体提前定义即可
 * 
        ...
        while (std::getline(file, line)) {
            ...
            try {
                ...
                // Parse SG_ (Signal)
                    ...
                    // Parse startBit|length@byteOrder (e.g., 60|4@1+ or 60|4@0+)
                    ...
                    // Determine byte order (@0 for Motorola, @1 for Intel)
